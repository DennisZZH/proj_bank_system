...
public class Account {
    ...
    public Account(String id, float rate, String branch_name, AccountType type, String primary_owner_id, boolean closed, double balance){
        this.account_id=id;
        this.rate=rate;
    ...
    public String getID(){return account_id;}
